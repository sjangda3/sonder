...
import FileUpload from "@/components/Inputs/FileUploads";
...
const Home: React.FC = () => {
  ...
  const { targetText, error } = useTranslate(sourceText, selectedLanguage);
  ...
  return (
    <div className="w-full gradient-mesh relative flex items-center justify-center min-h-screen">
        ...
        <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-24">
          <div className="text-center">
            <h1 className="text-4xl sm:text-6xl font-bold text-neutral-200">
              Sond<span className="text-[#bf06e0]">erly</span>
            </h1>
                ...
                <div className="relative z-10 flex flex-col space-x-3 p-3 border rounded-lg shadow-lg bg-neutral-900 border-neutral-700 shadow-gray-900/20">
                  ...
                  <div className="flex flex-row justify-between w-full">
                    <span className="cursor-pointer flex items-center space-x-2 flex-row">
                      ...
                      <IconVolume
                        size={22}
                        onClick={() => targetText && handleAudioPlayback(targetText)}
                      />
                    </span>
